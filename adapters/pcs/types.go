...
// ScienceClaimBundle is the PCS ScienceClaimBundle.v0 envelope.
type ScienceClaimBundle struct {
	...
	TraceCertificate *TraceCertificate `json:"trace_certificate"`
...
// VerificationResult is VerificationResult.v0 emitted by Provability Fabric.
...
const (
	...
	SchemaVerificationResult  = "VerificationResult.v0"
	SchemaScienceClaimBundle    = "ScienceClaimBundle.v0"
	SchemaSignedScienceClaim    = "SignedScienceClaimBundle.v0"
